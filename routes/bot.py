...
def bot_start():
    ...
    except Exception:  # noqa: BLE001 - fallback to SAT assistant
...
def bot_message():
    ...
    try:
        ...
        return jsonify({'messages': [text.strip()]})

    except Exception as exc:  # noqa: BLE001 - degrade gracefully
        current_app.logger.error('Error in bot_message function: %s', exc, exc_info=True)
